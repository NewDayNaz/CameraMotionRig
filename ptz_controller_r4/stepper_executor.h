 ...
 * @brief Deterministic step generation using Timer ISR
 * 
 * Uses Arduino Timer to generate step pulses at high frequency.
...
/**
 * @brief Update executor (call from main loop, not ISR)
 * This handles segment consumption and step distribution
 */
