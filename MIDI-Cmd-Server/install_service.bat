...
:startInstallation
  ...
  set SERVICE_DESCRIPTION=NodeJS script for Camera MIDI control Bridge
  ...
  :: replace server.js with the name of your script
  nssm set %SERVICE_NAME% AppParameters "camera_midi.js"
